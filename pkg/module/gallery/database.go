...
type ImageRepository interface {
	...
	CreateImage(ctx context.Context, model *model.Image) (string, error)
	UpdateImage(ctx context.Context, model *model.Image) error
	DeleteImage(ctx context.Context, model *model.Image) error
}
